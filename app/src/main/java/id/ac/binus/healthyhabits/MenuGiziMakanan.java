...
public class MenuGiziMakanan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_gizi_makanan);
        ...
        //Navigation Bar
        navbar.setSelectedItemId(R.id.MenuGiziMakanan);
        ...
        navigationEditProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MenuGiziMakanan.this, EditProfile.class);

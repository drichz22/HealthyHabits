...
public class MenuRumahSehat extends AppCompatActivity {
    private ImageView navigationEditProfile;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_menu_rumah_sehat);
        ...
        //Navigation Bar
        navbar.setSelectedItemId(R.id.MenuRumahSehat);
        ...
        navigationEditProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MenuRumahSehat.this, EditProfile.class);
